...
2. 반드시 아래 세 가지 정보를 모두 고려하여 시의 '주제'를 선정할 것.
   - 당신이 올린 '사진'에 나타나는 주제 (중요도 70%)
   - 당신의 '사연'에서 유추되는 주제 (중요도 20%)
   - 당신의 '기분 태그'에서 유추되는 주제 (중요도 10%)

3. 사진, 사연, 기분 태그를 모두 고려하여 가장 일반적으로 관련된 주제를 선정하고, 그 주제에 직접적으로 연결되는 시를 최우선으로 추천할 것.
    ...
    content: [
      {
        ...
        text:
          ...
          '링크는 절대 포함하지 말 것. ' +
          '사진, 사연, 기분 태그 순서대로 중요도를 설정하여 (사진 70%, 사연 20%, 기분 태그 10%) 시를 추천하고, 주제가 직접적으로 일치하지 않을 경우 분위기, 계절, 감정 등 부차적 요소를 고려할 것. ' +
