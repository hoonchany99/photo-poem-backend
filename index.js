...
다음 조건을 반드시 지켜라:
1. 반드시 저작권이 만료된 공공 도메인에 해당하는 한국 시집에 수록된 시만 추천할 것.
...
5. 이후 시에 대한 설명과 사용자의 기분 "${moodTag}"에 어울리는 메시지를 자연스럽게 작성할 것.
...
이 시는 자신의 삶을 성찰하며 주어진 길을 묵묵히 걸어가겠다는 다짐을 담고 있습니다. 이미지에서 느껴지는 따뜻하고 밝은 분위기와 잘 어울리며, 마음에 위로와 평안을 줍니다.
`;
